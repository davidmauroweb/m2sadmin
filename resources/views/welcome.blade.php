...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <style>
            ...
            html{line-height:1.15;-webkit-text-size-adjust:10%}
            body{margin:0}
    ...
    <body class="antialiased">
        <div class="relative flex items-top justify-center min-h-screen bg-gray-600 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
            @if (Route::has('login'))
        ...
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-0 sm:items-center py-4 sm:pt-0"><img src="{{ asset('img/m2storage.png') }}" alt="Logo" width="50%" height="50%"></div>
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-0 sm:items-center py-4 sm:pt-0"><h3>Sitema de control de clientes</h3></div>
